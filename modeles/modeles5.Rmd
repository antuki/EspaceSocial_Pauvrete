...
- [*Le troisième axe (horizontal figure 2) a une structure qui s’interprète difficilement : Q2, APA, Revenus de locations et d’actifs (à droite) et Q4, Q1 et RSA (à gauche). Son interprétation brouillerait le message des deux premiers axes.*]
...
points(c(2, 3, 6), inertie[c(2, 3, 6)], col = c("green3", "red3", "blue3","yellow3","pink3"), cex = 2, lwd = 3)
...
#Typologie en 6 classes
typo <- factor(factor(cutree(arbre,k=6),labels=c(2,5,3,4,6,1)),levels=1:6)
s.class(res.mca$ind$coord[,c(1,2)], typo, col = brewer.pal(7, "Set1")[c(1:5,7)], sub = "Axes 1 et 2")
