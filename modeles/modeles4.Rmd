...
L'objectif de cette quatrième série de modèles est ....
...
- On a ajouté une catégorie indépendants
- On considère aussi le revenu du référent ménage (La pauvreté s'évalue au niveau du ménage). D'ailleurs la profession de la personne référente explique mieux (meilleur R2) le sentiment de pauvreté. Idem pour le statut d'activité
-Statut d'activité n'explique pas autant que PCS en fait
