...
champ <- c("Personnes d’au moins 18 ans résidant en France métropolitaine.")
source <- c("Baromètre d’opinion de la DREES, 2015-2019.")
note <- c("A structure familiale fixée, le fait d'indiquer percevoir soi-même le RSA multiplie par 7 les chances d'indiquer se sentir pauvre. Le percevoir au niveau de son ménage, multiplie les chances par 5.")
...
```{r tabrsa1,fig.source = source, fig.note=note, fig.champ=champ}
